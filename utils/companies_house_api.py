"""
Companies House API Integration Module
...
class CompaniesHouseAPI:
    ...
    def __init__(self, api_key: str, use_sandbox: bool = False):
        ...
        self.session.headers.update({
            ...
            'User-Agent': 'Knowledge-Graph-Explorer/1.0'
        })
    ...
    def get_company_profile(self, company_number: str) -> Optional[CompanyProfile]:
        ...
        if 'business_activity' in response:
            ...
            # You could map SIC codes to descriptions here
...
def get_sic_code_description(sic_code: str) -> str:
    ...
    In a full implementation, you'd use the official SIC code database
    """
    sic_descriptions = {
...
if __name__ == "__main__":
    # This would be used for testing with a real API key
    # api = CompaniesHouseAPI("your_api_key_here")
    # companies = api.search_companies("Tesco")
